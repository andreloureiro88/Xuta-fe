...
const App: React.FC = () => {
  ...
  return (
    <body className="bg-[var(--deep-navy)] text-white font-sans">
      <header className="bg-[var(--vibrant-purple)]">
        <nav className="container mx-auto flex items-center justify-between py-4 px-6">
          ...
          <WalletConnect
            ...
            onWalletConnect={(walletName) => setSelectedWallet(walletName)}
          >
            <WalletModalPicker
              onConnect={(walletName) => setSelectedWallet(walletName)}
            />
          </WalletConnect>
        </nav>
      </header>
